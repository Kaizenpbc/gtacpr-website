...
<div class="drawer" id="drawer" role="dialog" aria-modal="true" aria-label="Navigation">
  <div class="drawer-header">
    <span class="drawer-header-title">
      <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/gtacpr-logo.png" alt="GTA CPR" width="325" height="88" style="height:32px;width:auto;display:block" loading="lazy" />
    </span>
  ...
  ?>
  <ul class="drawer-nav">
    <li><a href="<?php echo esc_url( get_permalink( get_page_by_path('about') ) ); ?>"<?php echo gtacpr_drawer_class('about'); ?>><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>About Us</a></li>
    <li><a href="<?php echo esc_url( get_permalink( get_page_by_path('courses') ) ); ?>"<?php echo gtacpr_drawer_class('courses'); ?>><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>Courses</a></li>
    <li><a href="<?php echo esc_url( get_permalink( get_page_by_path('group-training') ) ); ?>"<?php echo gtacpr_drawer_class('group-training'); ?>><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg>Group Training</a></li>
    <li><a href="<?php echo esc_url( get_permalink( get_page_by_path('esl') ) ); ?>"<?php echo gtacpr_drawer_class('esl'); ?>><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>ESL Classes</a></li>
    <li><a href="<?php echo esc_url( get_permalink( get_page_by_path('providers') ) ); ?>"<?php echo gtacpr_drawer_class('providers'); ?>><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>Providers</a></li>
