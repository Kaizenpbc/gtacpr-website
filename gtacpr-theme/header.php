...
<nav class="sitenav" aria-label="Main navigation">
  <div class="nav-inner">
    ...
    <ul class="nav-links">
      ...
      ?>
      <?php echo gtacpr_nav_item( 'About',         gtacpr_url('about'),          'about' ); ?>
      <?php echo gtacpr_nav_item( 'Courses',       gtacpr_url('courses'),        'courses' ); ?>
      <?php echo gtacpr_nav_item( 'Group Training', gtacpr_url('group-training'), 'group-training' ); ?>
      <?php echo gtacpr_nav_item( 'ESL',           gtacpr_url('esl'),            'esl' ); ?>
      <?php echo gtacpr_nav_item( 'Providers',     gtacpr_url('providers'),     'providers' ); ?>
      <li><a href="<?php echo esc_url($reviews_link); ?>">Reviews</a></li>
      <li><a href="<?php echo esc_url($faq_link); ?>">FAQ</a></li>
      <?php echo gtacpr_nav_item( 'Contact',       gtacpr_url('contact'),        'contact' ); ?>
    </ul>
    ...
    <div class="nav-right">
      ...
      <a href="<?php echo esc_url( gtacpr_url('register') ); ?>" class="nav-btn open-booking">Book a Class</a>
    </div>
...
<div class="drawer" id="drawer" role="dialog" aria-modal="true" aria-label="Navigation">
  ...
  <ul class="drawer-nav">
    ...
    <li><a href="<?php echo esc_url( gtacpr_url('group-training') ); ?>"<?php echo gtacpr_drawer_class('group-training'); ?>><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg>Group Training</a></li>
    <li><a href="<?php echo esc_url( gtacpr_url('esl') ); ?>"<?php echo gtacpr_drawer_class('esl'); ?>><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>ESL Classes</a></li>
    <li><a href="<?php echo esc_url( gtacpr_url('providers') ); ?>"<?php echo gtacpr_drawer_class('providers'); ?>><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>Providers</a></li>
  ...
  <div class="drawer-footer">
    ...
    <a href="<?php echo esc_url( gtacpr_url('register') ); ?>" class="d-book open-booking">Book a Class →</a>
  </div>
</div>
