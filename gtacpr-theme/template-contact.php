...
<div class="contact-section">
  ...
  <div class="contact-form-panel">
    ...
    <div class="form-success" id="formSuccess">
      ...
      <h3>Message Sent!</h3>
      <p>Thanks for reaching out. We'll get back to you within a few hours.<br>For urgent matters, call <a href="tel:<?php echo esc_attr( gtacpr_phone_raw() ); ?>" style="color:var(--red);font-weight:600"><?php echo esc_html( gtacpr_phone() ); ?></a>.</p>
    </div>
  </div>
  ...
  <div class="contact-info-panel">
    <div class="info-phone-card">
      ...
      <a href="tel:<?php echo esc_attr( gtacpr_phone_raw() ); ?>" class="info-phone-num"><?php echo esc_html( gtacpr_phone() ); ?></a>
      <div class="info-phone-sub">Available Mon–Sun, 9 AM – 5 PM</div>
      <a href="tel:<?php echo esc_attr( gtacpr_phone_raw() ); ?>" class="btn-call">
    ...
    <div class="info-card">
      ...
      <div class="info-card-body">
        <a href="mailto:<?php echo esc_attr( gtacpr_email() ); ?>"><?php echo esc_html( gtacpr_email() ); ?></a><br>
